...
public class MagicForm {
    ...
    private void setupFormFieldOnContentChangeMode(final FormField formField) {
        if (formField.getView() instanceof CompoundButton) {
            setupOnValueChangeListener(formField);
        } else if (formField.getView() instanceof TextView) {
            setupTextChangeListener(formField, true);
        }
    }

    private void setupOnValueChangeListener(final FormField formField) {
        final CompoundButton chk = (CompoundButton) formField.getView();
